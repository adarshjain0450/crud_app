...
con_string = "mongodb+srv://adarshjain:kritubaby0450@cluster0.wibc7z1.mongodb.net" 
client = pymongo.MongoClient(con_string)

db = client.get_database('kaardemo')

user_collection = pymongo.collection.Collection(db, 'adarshdemo')
...
def project_api_routes(endpoints):
    ...
    @endpoints.route('/create-section', methods=['POST'])
    def register_user():
        resp = {}
        try:
